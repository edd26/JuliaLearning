...
geom_betti_num, edgeDensities_g, persistenceIntervals, unboundedIntervals =
...
p_rand_ct = plot(edgeDensities_r, ran_betti_num[:,1], label="beta_0",
                                                title=title, legend=:topleft); #, ylims = (0,maxy)
plot!(edgeDensities_r, ran_betti_num[:,2], label="beta_1");
plot!(edgeDensities_r, ran_betti_num[:,3], label="beta_1");
...
plot!(edgeDensities_g, geom_betti_num[:,3], label="beta_1");
